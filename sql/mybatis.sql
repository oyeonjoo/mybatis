...
-- 과제] 테이블설계도를 보고 테이블 3개를 만들어라. --인코딩
-- 지금 system 이라 system에 생김.
/*
...
create table mybatis.posts (
    ...
    post_title varchar2(60), --앞에 post_title 이런거 달면 db내에서 유일한칼럼명
...
where owner = 'MYBATIS';
*/
-----------------------------맨위 drop user하고 다시 creat, grant. 테이블 새로 만드는 방법 쓰려고.
...
insert into mybatis.posts
    values(202, '비빔밥', '동학농민학쟁이 만든 음식이다.', 2);
insert into mybatis.posts
